...
resource "azurerm_linux_virtual_machine" "IN_VM" {
  ...
  provisioner "remote-exec" {
    inline = [ 
      ...
      "sudo su -c 'echo \"MAILER_ACCESS_TOKEN=${var.MAIL_SECRET_KEY}\" >> /home/${var.admin_username}/.env'",
      "sudo su -c 'echo \"MAPBOX_ACCESS_TOKEN=${var.MAPBOX_ACCESS_TOKEN}\" >> /home/${var.admin_username}/.env'",
      "sudo su -c 'echo \"MAILER_SERVICE=${var.MAIL_SERVICE}\" >> /home/${var.admin_username}/.env'",
      "sudo su -c 'echo \"MAILER_EMAIL=${var.MAIL_USER}\" >> /home/${var.admin_username}/.env'",
